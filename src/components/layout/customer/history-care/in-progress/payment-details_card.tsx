        ...
        <div className="bg-white border border-[#E5E7EB] rounded-3xl p-6">
            ...
            <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between items-center text-[#16A34A]">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="bg-[#F3E8FF] text-[#6D28D9] text-xs px-2 py-0.5 rounded-full font-medium">
                            Đã duyệt
                        </span>
                    </div>
                    <span>- 250,000 ₫</span>
            ...
            <div className="bg-[#F8FAFC] border border-[#E5E7EB] rounded-2xl p-3 mb-5 text-xs text-[#6B7280]">
                <div className="flex gap-2">
                    <AlertCircle className="w-5 h-5 mt-0.5 text-[#6D28D9]" />
                    <p>
                        Tiền đang được giữ an toàn trên hệ thống. Sẽ giải ngân cho nhà vườn sau khi bạn{' '}
                        <span className="font-medium">Xác nhận hoàn tất</span>. Hệ thống tự động xác nhận sau 48h kể từ lúc check-out.
                    </p>
                </div>
            </div>
            ...
            <div className="space-y-3">
                <button
                    onClick={handleApproveAddOn}
                    className="w-full bg-[#6D28D9] hover:bg-[#5B21B6] text-white font-semibold py-3 rounded-2xl transition-colors"
                >
                    Duyệt Add-on mới
                </button>
