...
export const ALL_ORDERS = [
    { id: 'LC-8821', customer: { name: 'Nguyễn Văn A', initials: 'NA', bgColor: 'bg-[#E5E0FF]', textColor: 'text-[#6D28D9]' }, orchidType: 'Lan Vanda Đỏ', service: 'Gói Phục hồi', status: { label: 'Đang chăm sóc', color: 'text-[#065F46]', bgColor: 'bg-[#D1FAE5]', dot: 'bg-[#10B981]' }, nextAction: 'Gửi báo cáo', deadline: '24/10/2023', isWarning: false },
    { id: 'LC-8822', customer: { name: 'Trần Thị B', initials: 'TB', bgColor: 'bg-[#E5E0FF]', textColor: 'text-[#6D28D9]' }, orchidType: 'Lan Đột Biến', service: 'Gói VIP', status: { label: 'Chờ check-in', color: 'text-[#6B21A8]', bgColor: 'bg-[#F3E8FF]', dot: 'bg-[#8B5CF6]' }, nextAction: 'Xác nhận nhận cây', deadline: '25/10/2023', isWarning: false },
    ...
    { id: 'LC-8826', customer: { name: 'Đỗ Thị F', initials: 'DF', bgColor: 'bg-[#E5E0FF]', textColor: 'text-[#6D28D9]' }, orchidType: 'Lan Ngọc Điểm', service: 'Gói VIP', status: { label: 'Tranh chấp', color: 'text-[#BE123C]', bgColor: 'bg-[#FFE4E6]', dot: 'bg-[#F43F5E]' }, nextAction: 'Xử lý khiếu nại', deadline: 'Quá hạn', isWarning: true },
    ...
    { id: 'LC-8830', customer: { name: 'Bùi Thị K', initials: 'BK', bgColor: 'bg-[#E5E0FF]', textColor: 'text-[#6D28D9]' }, orchidType: 'Lan Ngọc Điểm', service: 'Gói VIP', status: { label: 'Đang chăm sóc', color: 'text-[#065F46]', bgColor: 'bg-[#D1FAE5]', dot: 'bg-[#10B981]' }, nextAction: 'Bón phân', deadline: '01/11/2023', isWarning: false },
];
